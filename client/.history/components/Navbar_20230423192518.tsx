    ...
    <div className='navbar__container'>
      ...
      <div className='flex justify-center'>
        <div className={`navbar__bottom ${responsive} w-full flex items-center justify-content-between pt-2 md:px-5 sm:px-4 xsm:px-2 sm:p-0`}>
          <Image className='cursor-pointer -ml-[30px] sm:p-3 sm:h-[90px] sm:w-[100px] xsm:h-[50px] xsm:w-[60px]' src='/images/govLogo.jpg' height={100} width={100} alt="election-logo" onClick={() => navigate("/")} />
