...
const ElectionModal = ({ show, setShowCreateElectionModal, candidateLists }) => {
  ...
  console.log({ recentlyCreatedElection })
        ...
        <Modal.Body className='px-4'>
          ...
          {election?.electionType === "District" &&
            <div className='flex sm:flex-row xsm:flex-col'>
              ...
              <div className='w-[300px] my-4 sm:ml-4 xsm:ml-0'>
      ...
      <Modal show={show} centered>
        ...
        <Modal.Body>
          <div className='px-2'>
            ...
            <button
              className={`h-fit w-full flex items-center mt-4 rounded-3 border border-1 border-slate-400 bg-slate-200 ${recentlyCreatedElection?.length && election?.electionType && "cursor-pointer hover:bg-slate-100"}`}
            ...
            >
              ...
              <div className='bg-white flex-1 text-start px-3 py-[8px] text-slate-800'>{
                !candidateLists?.length ? "Candidates not found !" :
                  (!recentlyCreatedElection?.length ? "Choose candidates" : `Selected Candidates: ${election.selectedCandidates?.length}`)
              }</div>
            </button>
          </div >
        </Modal.Body >
