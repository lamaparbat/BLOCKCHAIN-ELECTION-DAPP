...
const LiveCounterCard: React.FC<LiveCounterCardStruct> = ({ type, data, electionStatus, casteVote }): ReactElement => {
  ...
  return (
    <div
      className={`card__container ${isElectionEnd && 'bg-celebrationGif'} h-fit sm:w-100 max-[1140px]:w-full mt-3 border border-1 border-slate-300 rounded-1 overflow-hidden mr-3`}>
      <div
