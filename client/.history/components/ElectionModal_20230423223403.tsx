      ...
      <Modal show={show} centered>
        ...
        <Modal.Body>
          <div className='px-2'>
            ...
            <button
              className={`h-fit w-full flex items-center mt-4 rounded-3 border border-1 border-slate-400 bg-slate-200 ${recentlyCreatedElection?.length && "cursor-pointer hover:bg-slate-100"}`}
