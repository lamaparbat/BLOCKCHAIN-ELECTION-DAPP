...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Navbar />
      <div className='lg:px-4 sm:px-4 xsm:px-1 py-3 flex lg:justify-center sm:justify-start xsm:justify-start mt-1 bg-info'>
        <div className='flex flex-column bg-primary w-full'>
          ...
          <div className='lg:w-[1100px] flex justify-around flex-wrap w-full bg-danger'>
