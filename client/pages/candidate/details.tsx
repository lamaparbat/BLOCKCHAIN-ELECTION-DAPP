 ...
 const FieldRow = ({ title1, title1Val, title2, title2Val }) => {
  return (
   <div className='flex justify-between mb-3'>
    <div>
     <h5>{title1}:</h5>
     <span className='relative -top-[5px]'>{title1Val}</span>
    </div>
    <div className='text-end'>
     <h5>{title2}:</h5>
     <span className='relative -top-[5px]'>{title2Val} years.</span>
    </div>
   </div>
  )
 }
 return (
  <div className='mb-[50px]'>
   ...
   <div className='w-full flex justify-center'>
    <div className='lg:w-[1100px] flex justify-between rounded-1 flex-wrap'>
     <div className='bg-slate-100 w-[450px] h-[370px] flex justify-center items-center overflow-hidden rounded-1'>
      {true ? <img src={'/images/parbat.png'} alt={candidateName} height="100%" width="100%" /> : <FaUserCircle className='text-3xl text-slate-500' />}
     </div>
     <div className='details w-[600px] -mt-[4px]'>
   ...
   <div className='w-full flex justify-center mt-1'>
    <div className='lg:w-[1100px] pt-3'>
